...
# 3. Inside the new environment, install IPython kernel so we can use this environment in jupyter notebook: 
    ...
    python -m ipykernel install --user --name dsci6004
...
# 5. To make sure we are using the right environment, go to the toolbar of exploring_word_vectors.ipynb, click on Kernel -> Change kernel, you should see and select dsci6004 in the drop-down menu.
